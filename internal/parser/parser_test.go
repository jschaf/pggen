	...
	tests := []struct {
		...
		},
		{
			...
			&ast.SourceQuery{
				...
				ParamHaveDefaults: map[string]bool{"Bar": false},
		...
		},
		{
			...
			&ast.SourceQuery{
				...
				ParamHaveDefaults: map[string]bool{"A$_$$B123": false},
				ResultKind:        ast.ResultKindOne,
			},
		},
		{
			...
			&ast.SourceQuery{
				...
				ParamHaveDefaults: map[string]bool{"Bar": false, "Qux": false},
				ResultKind:        ast.ResultKindMany,
			},
		},

		{
			...
			&ast.SourceQuery{
				...
				ParamNames:        []string{"Bar", "Qux"},
				ParamHaveDefaults: map[string]bool{"Bar": true, "Qux": true},
				ResultKind:        ast.ResultKindMany,
			},
		},
		{
			...
			&ast.SourceQuery{
				...
				ParamHaveDefaults: map[string]bool{"Qux": false, "Bar": false},
				ResultKind:        ast.ResultKindMany,
			},
		},
		{
