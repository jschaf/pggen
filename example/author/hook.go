...
type QueryHook interface {
	// BeforeQuery runs when a Querier function is first invoked.
...
type BeforeHookParams struct {
	// The name of the query as written in the SQL source file. From the token:
	//   -- name: FindAuthors
	QueryName string
...
type AfterHookParams struct {
	...
	// The result query error, if any. This does not include errors from reading
	// rows.
	QueryErr error
}
