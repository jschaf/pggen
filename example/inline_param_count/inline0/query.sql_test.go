...
func TestNewQuerier_FindAuthorByID(t *testing.T) {
	...
	t.Run("FindAuthorByID", func(t *testing.T) {
		authorByID, err := q.FindAuthorByID(context.Background(), FindAuthorByIDParams{AuthorID: adamsID})
		require.NoError(t, err)
	...
	t.Run("FindAuthorByID - none-exists", func(t *testing.T) {
		missingAuthorByID, err := q.FindAuthorByID(context.Background(), FindAuthorByIDParams{AuthorID: 888})
